...
* The original package name 'org.abl.demo.multitenant-datasource' is invalid and this project uses 'org.abl.demo.multitenant_datasource' instead.
...
```
$ docker run --rm multitenant-datasource:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/multitenant-datasource
```
